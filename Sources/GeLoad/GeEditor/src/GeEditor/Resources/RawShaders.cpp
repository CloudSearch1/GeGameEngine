...
std::pair<std::string, std::string> GeEditor::Resources::RawShaders::GetGrid()
{
...
std::pair<std::string, std::string> GeEditor::Resources::RawShaders::GetGizmo()
{
	std::pair<std::string, std::string> source;
...
std::pair<std::string, std::string> GeEditor::Resources::RawShaders::GetBillboard()
{
	std::pair<std::string, std::string> source;
