...
#define FILENAMES_CHARS GeEditor::Panels::AssetBrowser::__FILENAMES_CHARS
...
class TexturePreview : public GeUI::Plugins::IPlugin
{
public:
	...
	{
		texture = GeCore::Global::ServiceLocator::Get<GeCore::ResourceManagement::TextureManager>()[p_path];
	}
	...
	GeUI::Widgets::Visual::Image image;
};

class BrowserItemContextualMenu : public GeUI::Plugins::ContextualMenu
{
public:
	...
	virtual void CreateList()
	{
		if (!m_protected)
		{
			auto& renameMenu = CreateWidget<GeUI::Widgets::Menu::MenuList>("Rename to...");
			auto& deleteAction = CreateWidget<GeUI::Widgets::Menu::MenuItem>("Delete");

			auto& nameEditor = renameMenu.CreateWidget<GeUI::Widgets::InputFields::InputText>("");
			nameEditor.selectAllOnClick = true;

			renameMenu.ClickedEvent += [this, &nameEditor]
			{
				nameEditor.content = GeUtils::Utils::PathParser::GetElementName(filePath);
			...
			{
				if (!std::filesystem::is_directory(filePath))
					p_newName += '.' + GeUtils::Utils::PathParser::GetExtension(filePath);
				...
				std::string containingFolderPath = GeUtils::Utils::PathParser::GetContainingFolder(filePath);
...
public:
	bool m_protected;
	std::string filePath;
	GeUtils::Eventing::Event<std::string> DestroyedEvent;
	GeUtils::Eventing::Event<std::string, std::string> RenamedEvent;
};
...
public:
	...
	{
		auto& showInExplorer = CreateWidget<GeUI::Widgets::Menu::MenuItem>("Show in explorer");
		showInExplorer.ClickedEvent += [this]
		{
			GeUtils::Utils::SystemCalls::ShowInExplorer(filePath);
		};

		if (!m_protected)
		{
			auto& importAssetHere = CreateWidget<GeUI::Widgets::Menu::MenuItem>("Import Here...");
			importAssetHere.ClickedEvent += [this]
			{
				if (EDITOR_EXEC(ImportAssetAtLocation(filePath)))
				{
					GeUI::Widgets::Layout::TreeNode* pluginOwner = reinterpret_cast<GeUI::Widgets::Layout::TreeNode*>(userData);
					pluginOwner->Close();
					EDITOR_EXEC(DelayAction(std::bind(&GeUI::Widgets::Layout::TreeNode::Open, pluginOwner)));
				}
			};

			auto& createMenu = CreateWidget<GeUI::Widgets::Menu::MenuList>("Create..");

			auto& createFolderMenu = createMenu.CreateWidget<GeUI::Widgets::Menu::MenuList>("Folder");
			auto& createSceneMenu = createMenu.CreateWidget<GeUI::Widgets::Menu::MenuList>("Scene");
			auto& createShaderMenu = createMenu.CreateWidget<GeUI::Widgets::Menu::MenuList>("Shader");
			auto& createMaterialMenu = createMenu.CreateWidget<GeUI::Widgets::Menu::MenuList>("Material");

			auto& createStandardShaderMenu = createShaderMenu.CreateWidget<GeUI::Widgets::Menu::MenuList>("Standard template");
			auto& createStandardPBRShaderMenu = createShaderMenu.CreateWidget<GeUI::Widgets::Menu::MenuList>("Standard PBR template");
			auto& createUnlitShaderMenu = createShaderMenu.CreateWidget<GeUI::Widgets::Menu::MenuList>("Unlit template");
			auto& createLambertShaderMenu = createShaderMenu.CreateWidget<GeUI::Widgets::Menu::MenuList>("Lambert template");

			auto& createEmptyMaterialMenu = createMaterialMenu.CreateWidget<GeUI::Widgets::Menu::MenuList>("Empty");
			auto& createStandardMaterialMenu = createMaterialMenu.CreateWidget<GeUI::Widgets::Menu::MenuList>("Standard");
			auto& createStandardPBRMaterialMenu = createMaterialMenu.CreateWidget<GeUI::Widgets::Menu::MenuList>("Standard PBR");
			auto& createUnlitMaterialMenu = createMaterialMenu.CreateWidget<GeUI::Widgets::Menu::MenuList>("Unlit");
			auto& createLambertMaterialMenu = createMaterialMenu.CreateWidget<GeUI::Widgets::Menu::MenuList>("Lambert");

			auto& createFolder = createFolderMenu.CreateWidget<GeUI::Widgets::InputFields::InputText>("");
			auto& createScene = createSceneMenu.CreateWidget<GeUI::Widgets::InputFields::InputText>("");

			auto& createEmptyMaterial = createEmptyMaterialMenu.CreateWidget<GeUI::Widgets::InputFields::InputText>("");
			auto& createStandardMaterial = createStandardMaterialMenu.CreateWidget<GeUI::Widgets::InputFields::InputText>("");
			auto& createStandardPBRMaterial = createStandardPBRMaterialMenu.CreateWidget<GeUI::Widgets::InputFields::InputText>("");
			auto& createUnlitMaterial = createUnlitMaterialMenu.CreateWidget<GeUI::Widgets::InputFields::InputText>("");
			auto& createLambertMaterial = createLambertMaterialMenu.CreateWidget<GeUI::Widgets::InputFields::InputText>("");

			auto& createStandardShader = createStandardShaderMenu.CreateWidget<GeUI::Widgets::InputFields::InputText>("");
			auto& createStandardPBRShader = createStandardPBRShaderMenu.CreateWidget<GeUI::Widgets::InputFields::InputText>("");
			auto& createUnlitShader = createUnlitShaderMenu.CreateWidget<GeUI::Widgets::InputFields::InputText>("");
			auto& createLambertShader = createLambertShaderMenu.CreateWidget<GeUI::Widgets::InputFields::InputText>("");
			...
			createScene.EnterPressedEvent += [this](std::string newSceneName)
			{
				...
				outfile << "<root><scene><actors><actor><name>Directional Light</name><tag></tag><active>true</active><id>1</id><parent>0</parent><components><component><type>class GeCore::ECS::Components::CDirectionalLight</type><data><diffuse><x>1</x><y>1</y><z>1</z></diffuse><specular><x>1</x><y>1</y><z>1</z></specular><intensity>0.75</intensity></data></component><component><type>class GeCore::ECS::Components::CTransform</type><data><position><x>0</x><y>10</y><z>0</z></position><rotation><x>0.81379771</x><y>-0.17101006</y><z>0.29619816</z><w>0.46984628</w></rotation><scale><x>1</x><y>1</y><z>1</z></scale></data></component></components><behaviours/></actor><actor><name>Ambient Light</name><tag></tag><active>true</active><id>2</id><parent>0</parent><components><component><type>class GeCore::ECS::Components::CAmbientSphereLight</type><data><ambient><x>1</x><y>1</y><z>1</z></ambient><intensity>0.1</intensity><radius>10000</radius></data></component><component><type>class GeCore::ECS::Components::CTransform</type><data><position><x>0</x><y>0</y><z>0</z></position><rotation><x>0</x><y>0</y><z>0</z><w>1</w></rotation><scale><x>1</x><y>1</y><z>1</z></scale></data></component></components><behaviours/></actor><actor><name>Main Camera</name><tag></tag><active>true</active><id>3</id><parent>0</parent><components><component><type>class GeCore::ECS::Components::CCamera</type><data><fov>45</fov><near>0.1</near><far>1000</far><clear_color><x>0.1921569</x><y>0.3019608</y><z>0.47450981</z></clear_color></data></component><component><type>class GeCore::ECS::Components::CTransform</type><data><position><x>0</x><y>3</y><z>8</z></position><rotation><x>-7.5904039e-09</x><y>0.98480773</y><z>-0.17364819</z><w>-4.3047311e-08</w></rotation><scale><x>1</x><y>1</y><z>1</z></scale></data></component></components><behaviours/></actor></actors></scene></root>" << std::endl; // Empty scene content
			...
			createEmptyMaterial.EnterPressedEvent += [this](std::string materialName)
			{
				...
				{
					auto& materialEditor = EDITOR_PANEL(GeEditor::Panels::MaterialEditor, "Material Editor");
...
public:
	GeUtils::Eventing::Event<std::string> ItemAddedEvent;
};
...
public:
	...
	virtual void CreateList() override
	{
		...
		auto& newScriptMenu = CreateWidget<GeUI::Widgets::Menu::MenuList>("New script...");
		auto& nameEditor = newScriptMenu.CreateWidget<GeUI::Widgets::InputFields::InputText>("");

		newScriptMenu.ClickedEvent += [this, &nameEditor]
		{
			nameEditor.content = GeUtils::Utils::PathParser::GetElementName("");
		};
...
public:
	...
	virtual void CreateList() override
	{
		auto& editAction = CreateWidget<GeUI::Widgets::Menu::MenuItem>("Open");

		editAction.ClickedEvent += [this]
		{
			GeUtils::Utils::SystemCalls::OpenFile(filePath);
		};

		if (!m_protected)
		{
			auto& duplicateAction = CreateWidget<GeUI::Widgets::Menu::MenuItem>("Duplicate");
			...
			duplicateAction.ClickedEvent += [this]
			{
				...
				std::string extension = "." + GeUtils::Utils::PathParser::GetExtension(filePath);
                ...
                const auto newNameWithoutExtension = GeUtils::Utils::String::GenerateUnique(filePathWithoutExtension, filenameAvailable);
        ...
        auto& editMetadata = CreateWidget<GeUI::Widgets::Menu::MenuItem>("Properties");

        editMetadata.ClickedEvent += [this]
        {
            auto& panel = EDITOR_PANEL(GeEditor::Panels::AssetProperties, "Asset Properties");
...
public:
	GeUtils::Eventing::Event<std::string> DuplicateEvent;
};
...
public:
	...
	virtual void CreateList() override
	{
		auto& previewAction = CreateWidget<GeUI::Widgets::Menu::MenuItem>("Preview");

		previewAction.ClickedEvent += [this]
		{
			Resource* resource = GeCore::Global::ServiceLocator::Get<ResourceLoader>()[EDITOR_EXEC(GetResourcePath(filePath, m_protected))];
...
public:
	...
	virtual void CreateList() override
	{
		...
		auto& compileAction = CreateWidget<GeUI::Widgets::Menu::MenuItem>("Compile");

		compileAction.ClickedEvent += [this]
		{
			auto& shaderManager = OVSERVICE(GeCore::ResourceManagement::ShaderManager);
			std::string resourcePath = EDITOR_EXEC(GetResourcePath(filePath, m_protected));
			if (shaderManager.IsResourceRegistered(resourcePath))
			{
				/* Trying to recompile */
				GeRendering::Resources::Loaders::ShaderLoader::Recompile(*shaderManager[resourcePath], filePath);
			}
			else
			{
				/* Trying to compile */
				GeRendering::Resources::Shader* shader = OVSERVICE(GeCore::ResourceManagement::ShaderManager)[resourcePath];
				if (shader)
...
class ModelContextualMenu : public PreviewableContextualMenu<GeRendering::Resources::Model, GeCore::ResourceManagement::ModelManager>
{
public:
	...
	virtual void CreateList() override
	{
		auto& reloadAction = CreateWidget<GeUI::Widgets::Menu::MenuItem>("Reload");
		...
		if (!m_protected)
		{
			auto& generateMaterialsMenu = CreateWidget<GeUI::Widgets::Menu::MenuList>("Generate materials...");

			generateMaterialsMenu.CreateWidget<GeUI::Widgets::Menu::MenuItem>("Standard").ClickedEvent += [this]
			{
				auto& modelManager = OVSERVICE(GeCore::ResourceManagement::ModelManager);
				std::string resourcePath = EDITOR_EXEC(GetResourcePath(filePath, m_protected));
				if (auto model = modelManager.GetResource(resourcePath))
				{
					for (const std::string& materialName : model->GetMaterialNames())
					{
						...
						do
						{
							finalPath = GeUtils::Utils::PathParser::GetContainingFolder(filePath) + (!fails ? materialName : materialName + " (" + std::to_string(fails) + ')') + ".ovmat";
			...
			generateMaterialsMenu.CreateWidget<GeUI::Widgets::Menu::MenuItem>("StandardPBR").ClickedEvent += [this]
			{
				auto& modelManager = OVSERVICE(GeCore::ResourceManagement::ModelManager);
				std::string resourcePath = EDITOR_EXEC(GetResourcePath(filePath, m_protected));
				if (auto model = modelManager.GetResource(resourcePath))
			...
			generateMaterialsMenu.CreateWidget<GeUI::Widgets::Menu::MenuItem>("Unlit").ClickedEvent += [this]
			{
				auto& modelManager = OVSERVICE(GeCore::ResourceManagement::ModelManager);
				std::string resourcePath = EDITOR_EXEC(GetResourcePath(filePath, m_protected));
				if (auto model = modelManager.GetResource(resourcePath))
			...
			generateMaterialsMenu.CreateWidget<GeUI::Widgets::Menu::MenuItem>("Lambert").ClickedEvent += [this]
			{
				auto& modelManager = OVSERVICE(GeCore::ResourceManagement::ModelManager);
				std::string resourcePath = EDITOR_EXEC(GetResourcePath(filePath, m_protected));
				if (auto model = modelManager.GetResource(resourcePath))
...
class TextureContextualMenu : public PreviewableContextualMenu<GeRendering::Resources::Texture, GeCore::ResourceManagement::TextureManager>
{
public:
	...
	virtual void CreateList() override
	{
		...
		reloadAction.ClickedEvent += [this]
		{
			...
			if (textureManager.IsResourceRegistered(resourcePath))
			{
				...
				EDITOR_PANEL(GeEditor::Panels::MaterialEditor, "Material Editor").Refresh();
			}
		};
...
public:
	...
	virtual void CreateList() override
	{
		auto& editAction = CreateWidget<GeUI::Widgets::Menu::MenuItem>("Edit");
...
class MaterialContextualMenu : public PreviewableContextualMenu<GeCore::Resources::Material, GeCore::ResourceManagement::MaterialManager>
{
public:
	...
	virtual void CreateList() override
	{
		...
		editAction.ClickedEvent += [this]
		{
			GeCore::Resources::Material* material = OVSERVICE(GeCore::ResourceManagement::MaterialManager)[EDITOR_EXEC(GetResourcePath(filePath, m_protected))];
			if (material)
			{
				auto& materialEditor = EDITOR_PANEL(GeEditor::Panels::MaterialEditor, "Material Editor");
				...
				GeCore::Resources::Material* resource = GeCore::Global::ServiceLocator::Get<GeCore::ResourceManagement::MaterialManager>()[EDITOR_EXEC(GetResourcePath(filePath, m_protected))];
				auto& assetView = EDITOR_PANEL(GeEditor::Panels::AssetView, "Asset View");
				assetView.SetResource(resource);
				assetView.Open();
				assetView.Focus();
		...
		auto& reload = CreateWidget<GeUI::Widgets::Menu::MenuItem>("Reload");
		reload.ClickedEvent += [this]
		{
			auto materialManager = OVSERVICE(GeCore::ResourceManagement::MaterialManager);
			auto resourcePath = EDITOR_EXEC(GetResourcePath(filePath, m_protected));
			GeCore::Resources::Material* material = materialManager[resourcePath];
			if (material)
			{
...
GeEditor::Panels::AssetBrowser::AssetBrowser
(
	...
	m_projectScriptFolder(p_projectScriptFolder)
{
	if (!std::filesystem::exists(m_projectAssetFolder))
	{
		...
		GeWindow::Dialogs::MessageBox message
		(
			"Assets folder not found",
			"The \"Assets/\" folders hasn't been found in your project directory.\nIt has been automatically generated",
			GeWindow::Dialogs::MessageBox::EMessageType::WARNING,
			GeWindow::Dialogs::MessageBox::EButtonLayout::OK
		);
	}
...
void GeEditor::Panels::AssetBrowser::Fill()
{
	m_assetList->CreateWidget<GeUI::Widgets::Visual::Separator>();
...
void GeEditor::Panels::AssetBrowser::Clear()
{
	m_assetList->RemoveAllWidgets();
}

void GeEditor::Panels::AssetBrowser::Refresh()
{
	Clear();
	Fill();
}

void GeEditor::Panels::AssetBrowser::ParseFolder(Layout::TreeNode& p_root, const std::filesystem::directory_entry& p_directory, bool p_isEngineItem, bool p_scriptFolder)
{
...
void GeEditor::Panels::AssetBrowser::ConsiderItem(GeUI::Widgets::Layout::TreeNode* p_root, const std::filesystem::directory_entry& p_entry, bool p_isEngineItem, bool p_autoOpen, bool p_scriptFolder)
{
	bool isDirectory = p_entry.is_directory();
	std::string itemname = GeUtils::Utils::PathParser::GetElementName(p_entry.path().string());
	...
	GeUtils::Utils::PathParser::EFileType fileType = GeUtils::Utils::PathParser::GetFileType(itemname);

	// Unknown file, so we skip it
	if (fileType == GeUtils::Utils::PathParser::EFileType::UNKNOWN && !isDirectory)
	{
		return;
	}
	...
	itemGroup.CreateWidget<Visual::Image>(iconTextureID, GeMaths::FVector2{ 16, 16 }).lineBreak = false;
	...
	if (isDirectory)
	{
		...
		auto& ddSource = treeNode.AddPlugin<GeUI::Plugins::DDSource<std::pair<std::string, Layout::Group*>>>("Folder", resourceFormatPath, std::make_pair(resourceFormatPath, &itemGroup));
		...
		contextMenu.ItemAddedEvent += [this, &treeNode, path, p_isEngineItem, p_scriptFolder] (std::string p_string)
		{
			...
			ParseFolder(treeNode, std::filesystem::directory_entry(GeUtils::Utils::PathParser::GetContainingFolder(p_string)), p_isEngineItem, p_scriptFolder);
		};
		...
		if (!p_scriptFolder)
		{
			...
			{
				treeNode.AddPlugin<GeUI::Plugins::DDTarget<std::pair<std::string, Layout::Group*>>>("Folder").DataReceivedEvent += [this, &treeNode, path, p_isEngineItem](std::pair<std::string, Layout::Group*> p_data)
				{
					if (!p_data.first.empty())
					{
						std::string folderReceivedPath = EDITOR_EXEC(GetRealPath(p_data.first));

						std::string folderName = GeUtils::Utils::PathParser::GetElementName(folderReceivedPath) + '\\';
				...
				treeNode.AddPlugin<GeUI::Plugins::DDTarget<std::pair<std::string, Layout::Group*>>>("File").DataReceivedEvent += [this, &treeNode, path, p_isEngineItem](std::pair<std::string, Layout::Group*> p_data)
				{
					if (!p_data.first.empty())
					{
						std::string fileReceivedPath = EDITOR_EXEC(GetRealPath(p_data.first));

						std::string fileName = GeUtils::Utils::PathParser::GetElementName(fileReceivedPath);
			...
			contextMenu.RenamedEvent += [this, &treeNode, path, &ddSource, p_isEngineItem](std::string p_prev, std::string p_newPath)
			{
				...
				if (!std::filesystem::exists(p_newPath)) // Do not rename a folder if it already exists
				{
					...
					std::string elementName = GeUtils::Utils::PathParser::GetElementName(p_newPath);
					std::string data = GeUtils::Utils::PathParser::GetContainingFolder(ddSource.data.first) + elementName + "\\";
			...
			{
				treeNode.RemoveAllWidgets();
				ParseFolder(treeNode, std::filesystem::directory_entry(GeUtils::Utils::PathParser::GetContainingFolder(p_path)), p_isEngineItem);
			};
		...
		{
			treeNode.RemoveAllWidgets();
			std::string updatedPath = GeUtils::Utils::PathParser::GetContainingFolder(path) + treeNode.name;
	...
	else
	{
		...
		switch (fileType)
		{
		case GeUtils::Utils::PathParser::EFileType::MODEL:		contextMenu = &clickableText.AddPlugin<ModelContextualMenu>(path, protectedItem);		break;
		case GeUtils::Utils::PathParser::EFileType::TEXTURE:	contextMenu = &clickableText.AddPlugin<TextureContextualMenu>(path, protectedItem); 	break;
		case GeUtils::Utils::PathParser::EFileType::SHADER:		contextMenu = &clickableText.AddPlugin<ShaderContextualMenu>(path, protectedItem);		break;
		case GeUtils::Utils::PathParser::EFileType::MATERIAL:	contextMenu = &clickableText.AddPlugin<MaterialContextualMenu>(path, protectedItem);	break;
		case GeUtils::Utils::PathParser::EFileType::SCENE:		contextMenu = &clickableText.AddPlugin<SceneContextualMenu>(path, protectedItem);		break;
		...
		auto& ddSource = clickableText.AddPlugin<GeUI::Plugins::DDSource<std::pair<std::string, Layout::Group*>>>
		(
			"File",
			resourceFormatPath,
		...
		contextMenu->RenamedEvent += [&ddSource, &clickableText, p_scriptFolder](std::string p_prev, std::string p_newPath)
		{
			if (p_newPath != p_prev)
			{
				if (!std::filesystem::exists(p_newPath))
				{
					RenameAsset(p_prev, p_newPath);
					std::string elementName = GeUtils::Utils::PathParser::GetElementName(p_newPath);
					ddSource.data.first = GeUtils::Utils::PathParser::GetContainingFolder(ddSource.data.first) + elementName;
		...
		if (fileType == GeUtils::Utils::PathParser::EFileType::TEXTURE)
		{
