...
GeEditor::Panels::GameView::GameView
(
...
void GeEditor::Panels::GameView::Update(float p_deltaTime)
{
...
void GeEditor::Panels::GameView::_Render_Impl()
{
...
bool GeEditor::Panels::GameView::HasCamera() const
{
	return m_hasCamera;
}

std::optional<GeRendering::Data::Frustum> GeEditor::Panels::GameView::GetActiveFrustum() const
{
	return m_hasCamera ? m_camera.GetFrustum() : std::optional<GeRendering::Data::Frustum>{};
}
