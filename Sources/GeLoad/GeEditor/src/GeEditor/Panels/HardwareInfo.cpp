...
GeEditor::Panels::HardwareInfo::HardwareInfo
(
	...
	m_hardwareInfo(new GeAnalytics::Hardware::HardwareInfo(m_logFrequency))
{
...
void GeEditor::Panels::HardwareInfo::Update(float p_deltaTime)
{
	m_hardwareInfo->Tick();
	...
	{
		GeAnalytics::Hardware::HardwareReport report = m_hardwareInfo->GenerateReport();
