...
namespace GeRendering::Data
{
  ...
  void Frustum::CalculateFrustum(const GeMaths::FMatrix4& p_viewProjection)
  {
  ...
  bool Frustum::BoundingSphereInFrustum(const GeRendering::Geometry::BoundingSphere& p_boundingSphere, const GeMaths::FTransform& p_transform) const
  {
