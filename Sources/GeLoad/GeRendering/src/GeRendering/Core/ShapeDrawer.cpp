...
GeRendering::Core::ShapeDrawer::ShapeDrawer(GeRendering::Core::Renderer& p_renderer) : m_renderer(p_renderer)
{
   ...
   void main()
   {
	...
	m_lineShader = GeRendering::Resources::Loaders::ShaderLoader::CreateFromSource(vertexShader, fragmentShader);
	...
	m_gridShader = GeRendering::Resources::Loaders::ShaderLoader::CreateFromSource(vertexShader, fragmentShader);
}

GeRendering::Core::ShapeDrawer::~ShapeDrawer()
{
	delete m_lineMesh;
	GeRendering::Resources::Loaders::ShaderLoader::Destroy(m_lineShader);
}

void GeRendering::Core::ShapeDrawer::SetViewProjection(const GeMaths::FMatrix4& p_viewProjection)
{
	m_lineShader->Bind();
...
void GeRendering::Core::ShapeDrawer::DrawLine(const GeMaths::FVector3& p_start, const GeMaths::FVector3& p_end, const GeMaths::FVector3& p_color, float p_lineWidth)
{
	m_lineShader->Bind();
...
void GeRendering::Core::ShapeDrawer::DrawGrid(const GeMaths::FVector3& p_viewPos, const GeMaths::FVector3& p_color, int32_t p_gridSize, float p_linear, float p_quadratic, float p_fadeThreshold, float p_lineWidth)
{
	m_gridShader->Bind();
