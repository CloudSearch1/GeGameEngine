...
GeMaths::FTransform::FTransform(FVector3 p_localPosition, FQuaternion p_localRotation, FVector3 p_localScale) :
...
GeMaths::FTransform::~FTransform()
{
	Notifier.NotifyChildren(Internal::TransformNotifier::ENotification::TRANSFORM_DESTROYED);
}

void GeMaths::FTransform::NotificationHandler(Internal::TransformNotifier::ENotification p_notification)
{
...
void GeMaths::FTransform::SetParent(FTransform& p_parent)
{
	m_parent = &p_parent;
...
bool GeMaths::FTransform::RemoveParent()
{
	if (m_parent != nullptr)
	{
...
bool GeMaths::FTransform::HasParent() const
{
	return m_parent != nullptr;
}

void GeMaths::FTransform::GenerateMatrices(FVector3 p_position, FQuaternion p_rotation, FVector3 p_scale)
{
...
void GeMaths::FTransform::UpdateWorldMatrix()
{
...
void GeMaths::FTransform::SetLocalPosition(FVector3 p_newPosition)
{
	GenerateMatrices(p_newPosition, m_localRotation, m_localScale);
}

void GeMaths::FTransform::SetLocalRotation(FQuaternion p_newRotation)
{
	GenerateMatrices(m_localPosition, p_newRotation, m_localScale);
}

void GeMaths::FTransform::SetLocalScale(FVector3 p_newScale)
{
	GenerateMatrices(m_localPosition, m_localRotation, p_newScale);
}

void GeMaths::FTransform::SetWorldPosition(FVector3 p_newPosition)
{
	GenerateMatrices(p_newPosition, m_worldRotation, m_worldScale);
}

void GeMaths::FTransform::SetWorldRotation(FQuaternion p_newRotation)
{
	GenerateMatrices(m_worldPosition, p_newRotation, m_worldScale);
}

void GeMaths::FTransform::SetWorldScale(FVector3 p_newScale)
{
	GenerateMatrices(m_worldPosition, m_worldRotation, p_newScale);
}

void GeMaths::FTransform::TranslateLocal(const FVector3& p_translation)
{
	SetLocalPosition(m_localPosition + p_translation);
}

void GeMaths::FTransform::RotateLocal(const FQuaternion& p_rotation)
{
	SetLocalRotation(m_localRotation * p_rotation);
}

void GeMaths::FTransform::ScaleLocal(const FVector3& p_scale)
{
...
const GeMaths::FVector3& GeMaths::FTransform::GetLocalPosition() const
{
	return m_localPosition;
}

const GeMaths::FQuaternion& GeMaths::FTransform::GetLocalRotation() const
{
	return m_localRotation;
}

const GeMaths::FVector3& GeMaths::FTransform::GetLocalScale() const
{
	return m_localScale;
}

const GeMaths::FVector3& GeMaths::FTransform::GetWorldPosition() const
{
	return m_worldPosition;
}

const GeMaths::FQuaternion& GeMaths::FTransform::GetWorldRotation() const
{
	return m_worldRotation;
}

const GeMaths::FVector3& GeMaths::FTransform::GetWorldScale() const
{
	return m_worldScale;
}

const GeMaths::FMatrix4& GeMaths::FTransform::GetLocalMatrix() const
{
	return m_localMatrix;
}

const GeMaths::FMatrix4& GeMaths::FTransform::GetWorldMatrix() const
{
	return m_worldMatrix;
}

GeMaths::FVector3 GeMaths::FTransform::GetWorldForward() const
{
	return m_worldRotation * FVector3::Forward;
}

GeMaths::FVector3 GeMaths::FTransform::GetWorldUp() const
{
	return m_worldRotation * FVector3::Up;
}

GeMaths::FVector3 GeMaths::FTransform::GetWorldRight() const
{
	return m_worldRotation * FVector3::Right;
}

GeMaths::FVector3 GeMaths::FTransform::GetLocalForward() const
{
	return m_localRotation * FVector3::Forward;
}

GeMaths::FVector3 GeMaths::FTransform::GetLocalUp() const
{
	return m_localRotation * FVector3::Up;
}

GeMaths::FVector3 GeMaths::FTransform::GetLocalRight() const
{
	return m_localRotation * FVector3::Right;
}

void GeMaths::FTransform::PreDecomposeWorldMatrix()
{
...
void GeMaths::FTransform::PreDecomposeLocalMatrix()
{
