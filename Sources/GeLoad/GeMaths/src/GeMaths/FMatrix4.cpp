...
GeMaths::FMatrix4::FMatrix4(const FMatrix4& p_other)
{
	*this = p_other;
}

GeMaths::FMatrix4& GeMaths::FMatrix4::operator=(const FMatrix4& p_other)
{
	memcpy(this->data, p_other.data, 16 * sizeof(float));
	return *this;
}

bool GeMaths::FMatrix4::operator==(const FMatrix4& p_other)
{
	return AreEquals(*this, p_other);
}

GeMaths::FMatrix4 GeMaths::FMatrix4::operator+(const FMatrix4& p_other) const
{
...
GeMaths::FMatrix4 GeMaths::FMatrix4::operator-(float p_scalar) const
{
...
GeMaths::FMatrix4& GeMaths::FMatrix4::operator*=(float p_scalar)
{
	*this = Multiply(*this, p_scalar);
	return *this;
}

GeMaths::FVector4 GeMaths::FMatrix4::operator*(const FVector4& p_vector) const
{
...
float& GeMaths::FMatrix4::operator()(uint8_t p_row, uint8_t p_column)
{
...
bool GeMaths::FMatrix4::AreEquals(const FMatrix4& p_left, const FMatrix4& p_right)
{
	return memcmp(&p_left, &p_right, 16 * sizeof(float)) == 0;
}

GeMaths::FMatrix4 GeMaths::FMatrix4::Add(const FMatrix4& p_left, float p_scalar)
{
...
GeMaths::FMatrix4 GeMaths::FMatrix4::Add(const FMatrix4& p_left, const FMatrix4& p_right)
{
	FMatrix4 result(p_left);
	for (int8_t i = 0; i < 16; i++)
...
GeMaths::FMatrix4 GeMaths::FMatrix4::Subtract(const FMatrix4& p_left, float p_scalar)
{
	FMatrix4 result(p_left);
	for (int8_t i = 0; i < 16; ++i)
		result.data[i] -= p_scalar;
...
GeMaths::FMatrix4 GeMaths::FMatrix4::Subtract(const FMatrix4& p_left, const FMatrix4& p_right)
{
	FMatrix4 result(p_left);
	for (int8_t i = 0; i < 16; ++i)
		result.data[i] -= p_right.data[i];
...
GeMaths::FMatrix4 GeMaths::FMatrix4::Multiply(const FMatrix4& p_left, float p_scalar)
{
	FMatrix4 result(p_left);
	for (int8_t i = 0; i < 16; ++i)
		result.data[i] *= p_scalar;
...
GeMaths::FVector4 GeMaths::FMatrix4::Multiply(const FMatrix4& p_matrix, const FVector4& p_vector)
{
	FVector4 multiply;
...
GeMaths::FMatrix4 GeMaths::FMatrix4::Multiply(const FMatrix4& p_left, const FMatrix4& p_right)
{
	return FMatrix4(
...
GeMaths::FMatrix4 GeMaths::FMatrix4::Divide(const FMatrix4& p_left, float p_scalar)
{
	FMatrix4 result(p_left);
...
GeMaths::FMatrix4 GeMaths::FMatrix4::Divide(const FMatrix4& p_left, const FMatrix4& p_right)
{
	FMatrix4 leftCopy(p_left);
	return leftCopy * Inverse(p_right);
}

bool GeMaths::FMatrix4::IsIdentity(const FMatrix4& p_matrix)
{
	return memcmp(Identity.data, p_matrix.data, 16 * sizeof(float)) == 0;
}

float GeMaths::FMatrix4::GetMinor(float p_minor0, float p_minor1, float p_minor2, float p_minor3, float p_minor4, float p_minor5, float p_minor6, float p_minor7, float p_minor8)
{
...
float GeMaths::FMatrix4::Determinant(const FMatrix4& p_matrix)
{
...
GeMaths::FMatrix4 GeMaths::FMatrix4::Transpose(const FMatrix4& p_matrix)
{
...
GeMaths::FMatrix4 GeMaths::FMatrix4::Inverse(const FMatrix4& p_matrix)
{
...
GeMaths::FMatrix4 GeMaths::FMatrix4::Translation(const FVector3& p_translation)
{
...
GeMaths::FMatrix4 GeMaths::FMatrix4::Translate(const FMatrix4& p_matrix, const FVector3& p_translation)
{
	return p_matrix * Translation(p_translation);
}

GeMaths::FMatrix4 GeMaths::FMatrix4::RotationOnAxisX(float p_rotation)
{
...
GeMaths::FMatrix4 GeMaths::FMatrix4::RotateOnAxisX(const FMatrix4& p_matrix, float p_rotation)
{
	return p_matrix * RotationOnAxisX(p_rotation);
}

GeMaths::FMatrix4 GeMaths::FMatrix4::RotationOnAxisY(float p_rotation)
{
...
GeMaths::FMatrix4 GeMaths::FMatrix4::RotateOnAxisY(const FMatrix4& p_matrix, float p_rotation)
{
	return p_matrix * RotationOnAxisY(p_rotation);
}

GeMaths::FMatrix4 GeMaths::FMatrix4::RotationOnAxisZ(float p_rotation)
{
...
GeMaths::FMatrix4 GeMaths::FMatrix4::RotateOnAxisZ(const FMatrix4& p_matrix, float p_rotation)
{
	return p_matrix * RotationOnAxisZ(p_rotation);
}

GeMaths::FMatrix4 GeMaths::FMatrix4::RotationYXZ(float p_rotation)
{
...
GeMaths::FMatrix4 GeMaths::FMatrix4::RotateYXZ(const FMatrix4& p_matrix, float p_rotation)
{
	return p_matrix * RotationYXZ(p_rotation);
}

GeMaths::FMatrix4 GeMaths::FMatrix4::Scaling(const FVector3& p_scale)
{
...
GeMaths::FMatrix4 GeMaths::FMatrix4::Scale(const FMatrix4& p_matrix, const FVector3& p_scale)
{
	return p_matrix * Scaling(p_scale);
}

GeMaths::FMatrix4 GeMaths::FMatrix4::Rotation(const FQuaternion& p_quaternion)
{
	return GeMaths::FQuaternion::ToMatrix4(p_quaternion);
}

GeMaths::FMatrix4 GeMaths::FMatrix4::Rotate(const FMatrix4& p_matrix, const FQuaternion& p_quaternion)
{
	return p_matrix * Rotation(p_quaternion);
}

GeMaths::FMatrix4 GeMaths::FMatrix4::CreatePerspective(const float p_fov, const float p_aspectRatio, const float p_zNear, const float p_zFar)
{
...
GeMaths::FMatrix4 GeMaths::FMatrix4::CreateOrthographic(const float p_size, const float p_aspectRatio, const float p_zNear, const float p_zFar)
{
    auto ortho = GeMaths::FMatrix4::Identity;
...
GeMaths::FMatrix4 GeMaths::FMatrix4::CreateView(const float p_eyeX, const float p_eyeY, const float p_eyeZ, const float p_lookX, const float p_lookY, const float p_lookZ, const float p_upX, const float p_upY, const float p_upZ)
{
	const GeMaths::FVector3 eye(p_eyeX, p_eyeY, p_eyeZ);
	const GeMaths::FVector3 look(p_lookX, p_lookY, p_lookZ);
	const GeMaths::FVector3 up(p_upX, p_upY, p_upZ);

	const GeMaths::FVector3 forward(eye - look);
	FVector3::Normalize(forward);

	const GeMaths::FVector3 upXForward(GeMaths::FVector3::Cross(up, forward));
	FVector3::Normalize(upXForward);

	const GeMaths::FVector3 v(GeMaths::FVector3::Cross(forward, upXForward));

	GeMaths::FMatrix4 View;

	View.data[0] = upXForward.x;
	View.data[1] = upXForward.y;
	View.data[2] = upXForward.z;
	View.data[3] = -GeMaths::FVector3::Dot(eye, upXForward);
	
	View.data[4] = v.x;
	View.data[5] = v.y;
	View.data[6] = v.z;
	View.data[7] = -GeMaths::FVector3::Dot(eye, v);

	View.data[8] = forward.x;
	View.data[9] = forward.y;
	View.data[10] = forward.z;
	View.data[11] = -GeMaths::FVector3::Dot(eye, forward);

	return View;
}

GeMaths::FMatrix4 GeMaths::FMatrix4::CreateFrustum(const float p_left, const float p_right, const float p_bottom, const float p_top, const float p_zNear, const float p_zFar)
{
...
GeMaths::FVector4 GeMaths::FMatrix4::GetRow(const FMatrix4& p_matrix, uint8_t p_row)
{
	if (p_row >= 4)
...
GeMaths::FVector4 GeMaths::FMatrix4::GetColumn(const FMatrix4& p_matrix, uint8_t p_column)
{
	if (p_column >= 4)
