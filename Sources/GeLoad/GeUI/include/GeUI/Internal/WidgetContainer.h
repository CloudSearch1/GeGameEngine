...
#include "GeUI/Internal/EMemoryMode.h"
...
namespace GeUI::Internal
{
	...
	*/
	...
	public:
		...
		*/
		std::vector<std::pair<GeUI::Widgets::AWidget*, Internal::EMemoryMode>>& GetWidgets();

	protected:
		std::vector<std::pair<GeUI::Widgets::AWidget*, Internal::EMemoryMode>> m_widgets;
