...
#include "GeUI/API/IDrawable.h"
#include "GeUI/Plugins/Pluginable.h"
#include "GeUI/Plugins/DataDispatcher.h"
#include "GeUI/ImGui/imgui.h"

namespace  GeUI::Internal { class WidgetContainer; }

namespace GeUI::Widgets
{
	/**
	* A AWidget is the base class for any widget of GeUI.
