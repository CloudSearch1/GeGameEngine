...
#include "GeUI/Widgets/Sliders/ESliderOrientation.h"
#include "GeUI/Internal/Converter.h"

namespace GeUI::Widgets::Sliders
{
	/**
	...
	*/
	...
	public:
		...
		GeMaths::FVector2 verticalModeSize; /* Only applied with ESliderOrientation::VERTICAL */
		std::string label;
		std::string format;
		GeUtils::Eventing::Event<T> ValueChangedEvent;
