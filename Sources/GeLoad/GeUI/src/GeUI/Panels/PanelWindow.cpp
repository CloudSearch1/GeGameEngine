...
GeUI::Panels::PanelWindow::PanelWindow(const std::string& p_name, bool p_opened, const Settings::PanelWindowSettings& p_floatingPanelSettings) :
	name(p_name),
...
void GeUI::Panels::PanelWindow::Open()
{
	if (!m_opened)
	{
		m_opened = true;
...
void GeUI::Panels::PanelWindow::Close()
{
	if (m_opened)
	{
		m_opened = false;
...
void GeUI::Panels::PanelWindow::Focus()
{
	ImGui::SetWindowFocus((name + m_panelID).c_str());
}

void GeUI::Panels::PanelWindow::SetOpened(bool p_value)
{
	if (p_value != m_opened)
	{
		m_opened = p_value;
...
bool GeUI::Panels::PanelWindow::IsOpened() const
{
	return m_opened;
}

bool GeUI::Panels::PanelWindow::IsHovered() const
{
	return m_hovered;
}

bool GeUI::Panels::PanelWindow::IsFocused() const
{
	return m_focused;
}

bool GeUI::Panels::PanelWindow::IsAppearing() const
{
...
void GeUI::Panels::PanelWindow::ScrollToBottom()
{
    m_mustScrollToBottom = true;
}

void GeUI::Panels::PanelWindow::ScrollToTop()
{
    m_mustScrollToTop = true;
}

bool GeUI::Panels::PanelWindow::IsScrolledToBottom() const
{
    return m_scrolledToBottom;
}

bool GeUI::Panels::PanelWindow::IsScrolledToTop() const
{
    return m_scrolledToTop;
}

void GeUI::Panels::PanelWindow::_Draw_Impl()
{
	if (m_opened)
	{
