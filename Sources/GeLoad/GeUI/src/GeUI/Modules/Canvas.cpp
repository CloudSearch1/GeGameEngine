...
void GeUI::Modules::Canvas::AddPanel(Panels::APanel & p_panel)
{
	m_panels.push_back(std::ref(p_panel));
}

void GeUI::Modules::Canvas::RemovePanel(Panels::APanel & p_panel)
{
...
void GeUI::Modules::Canvas::RemoveAllPanels()
{
	m_panels.clear();
}

void GeUI::Modules::Canvas::MakeDockspace(bool p_state)
{
	m_isDockspace = p_state;
}

bool GeUI::Modules::Canvas::IsDockspace() const
{
