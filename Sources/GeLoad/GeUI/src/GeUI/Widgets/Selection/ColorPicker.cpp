...
#include "GeUI/Widgets/Selection/ColorPicker.h"

GeUI::Widgets::Selection::ColorPicker::ColorPicker(bool p_enableAlpha, const Types::Color & p_defaultColor) :
	DataWidget<Types::Color>(color), enableAlpha(p_enableAlpha), color(p_defaultColor)
{
}

void GeUI::Widgets::Selection::ColorPicker::_Draw_Impl()
{
