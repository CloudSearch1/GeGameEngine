...
#include "GeUI/Widgets/Selection/RadioButtonLinker.h"

GeUI::Widgets::Selection::RadioButtonLinker::RadioButtonLinker() : DataWidget<int>(m_selected)
{
}

void GeUI::Widgets::Selection::RadioButtonLinker::Link(RadioButton& p_radioButton)
{
...
void GeUI::Widgets::Selection::RadioButtonLinker::Unlink(RadioButton& p_radioButton)
{
	auto it = std::find_if(m_radioButtons.begin(), m_radioButtons.end(), [&p_radioButton](std::pair<GeUtils::Eventing::ListenerID, std::reference_wrapper<RadioButton>>& p_pair)
	{
...
int GeUI::Widgets::Selection::RadioButtonLinker::GetSelected() const
{
	return m_selected;
}

void GeUI::Widgets::Selection::RadioButtonLinker::_Draw_Impl()
{
	// The RadioButtonLinker is special, it has nothing to display :)
}

void GeUI::Widgets::Selection::RadioButtonLinker::OnRadioButtonClicked(int p_radioID)
{
