...
#include "GeUI/Widgets/Buttons/ButtonColored.h"
#include "GeUI/Internal/Converter.h"

GeUI::Widgets::Buttons::ButtonColored::ButtonColored(const std::string & p_label, const Types::Color& p_color, const GeMaths::FVector2& p_size, bool p_enableAlpha) :
	label(p_label), color(p_color), size(p_size), enableAlpha(p_enableAlpha)
{
}

void GeUI::Widgets::Buttons::ButtonColored::_Draw_Impl()
{
