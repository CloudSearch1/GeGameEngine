...
{
  std::pair<float, SizeConverter::ESizeUnit> SizeConverter::ConvertToOptimalUnit(float p_value, ESizeUnit p_unit)
  {
  ...
  float SizeConverter::Convert(float p_value, ESizeUnit p_from, ESizeUnit p_to)
  {
  ...
  std::string SizeConverter::UnitToString(ESizeUnit p_unit)
  {
    switch (p_unit)
    {
    case SizeConverter::ESizeUnit::BYTE:      return "B";
    case SizeConverter::ESizeUnit::KILO_BYTE: return "KB";
    case SizeConverter::ESizeUnit::MEGA_BYTE: return "MB";
    case SizeConverter::ESizeUnit::GIGA_BYTE: return "GB";
    case SizeConverter::ESizeUnit::TERA_BYTE: return "TB";
    }
