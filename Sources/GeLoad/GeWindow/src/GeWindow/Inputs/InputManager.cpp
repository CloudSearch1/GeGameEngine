...
GeWindow::Inputs::InputManager::InputManager(Window& p_window) : m_window(p_window)
{
...
GeWindow::Inputs::InputManager::~InputManager()
{
...
GeWindow::Inputs::EKeyState GeWindow::Inputs::InputManager::GetKeyState(EKey p_key) const
{
...
GeWindow::Inputs::EMouseButtonState GeWindow::Inputs::InputManager::GetMouseButtonState(EMouseButton p_button) const
{
...
bool GeWindow::Inputs::InputManager::IsKeyPressed(EKey p_key) const
{
	return m_keyEvents.find(p_key) != m_keyEvents.end() && m_keyEvents.at(p_key) == EKeyState::KEY_DOWN;
}

bool GeWindow::Inputs::InputManager::IsKeyReleased(EKey p_key) const
{
	return m_keyEvents.find(p_key) != m_keyEvents.end() && m_keyEvents.at(p_key) == EKeyState::KEY_UP;
}

bool GeWindow::Inputs::InputManager::IsMouseButtonPressed(EMouseButton p_button) const
{
...
bool GeWindow::Inputs::InputManager::IsMouseButtonReleased(EMouseButton p_button) const
{
...
std::pair<double, double> GeWindow::Inputs::InputManager::GetMousePosition() const
{
...
void GeWindow::Inputs::InputManager::ClearEvents()
{
	m_keyEvents.clear();
	m_mouseButtonEvents.clear();
}

void GeWindow::Inputs::InputManager::OnKeyPressed(int p_key)
{
	m_keyEvents[static_cast<EKey>(p_key)] = EKeyState::KEY_DOWN;
}

void GeWindow::Inputs::InputManager::OnKeyReleased(int p_key)
{
	m_keyEvents[static_cast<EKey>(p_key)] = EKeyState::KEY_UP;
}

void GeWindow::Inputs::InputManager::OnMouseButtonPressed(int p_button)
{
	m_mouseButtonEvents[static_cast<EMouseButton>(p_button)] = EMouseButtonState::MOUSE_DOWN;
}

void GeWindow::Inputs::InputManager::OnMouseButtonReleased(int p_button)
{
