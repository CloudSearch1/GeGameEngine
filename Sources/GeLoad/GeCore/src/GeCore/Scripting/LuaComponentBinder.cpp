...
void GeCore::Scripting::LuaComponentBinder::BindComponent(sol::state & p_luaState)
{
    ...
    p_luaState.new_enum<GeCore::ECS::Components::CModelRenderer::EFrustumBehaviour>("FrustumBehaviour",
        {
            {"DISABLED",		GeCore::ECS::Components::CModelRenderer::EFrustumBehaviour::DISABLED},
            {"CULL_MODEL",		GeCore::ECS::Components::CModelRenderer::EFrustumBehaviour::CULL_MODEL},
            {"CULL_MESHES",		GeCore::ECS::Components::CModelRenderer::EFrustumBehaviour::CULL_MESHES},
            {"CULL_CUSTOM",		GeCore::ECS::Components::CModelRenderer::EFrustumBehaviour::CULL_CUSTOM}
        });
	...
	p_luaState.new_enum<GePhysics::Entities::PhysicalObject::ECollisionDetectionMode>("CollisionDetectionMode",
		{
			{"DISCRETE",		GePhysics::Entities::PhysicalObject::ECollisionDetectionMode::DISCRETE},
			{"CONTINUOUS",		GePhysics::Entities::PhysicalObject::ECollisionDetectionMode::CONTINUOUS}
		});
    ...
    p_luaState.new_enum<GeRendering::Settings::EProjectionMode>("ProjectionMode",
    {
        {"ORTHOGRAPHIC",	GeRendering::Settings::EProjectionMode::ORTHOGRAPHIC},
        {"PERSPECTIVE",		GeRendering::Settings::EProjectionMode::PERSPECTIVE}
    });
