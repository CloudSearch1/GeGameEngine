...
void GeCore::Scripting::LuaGlobalsBinder::BindGlobals(sol::state & p_luaState)
{
	using namespace GeWindow;
	using namespace GeWindow::Inputs;
	using namespace GeMaths;
	using namespace GeCore::ECS;
	using namespace GeCore::SceneSystem;
	...
	p_luaState["Math"]["RandomInt"] = [](int p_min, int p_max) { return GeUtils::Utils::Random::Generate(p_min, p_max); };
	p_luaState["Math"]["RandomFloat"] = [](float p_min, float p_max) { return GeUtils::Utils::Random::Generate(p_min, p_max); };
	p_luaState["Math"]["CheckPercentage"] = [](float p_percentage) { return GeUtils::Utils::Random::CheckPercentage(p_percentage); };
	...
	p_luaState["Physics"]["Raycast"] = [](const GeMaths::FVector3& p_origin, const GeMaths::FVector3& p_direction, float p_distance) -> std::optional<PhysicsWrapper::RaycastHit>
	{
