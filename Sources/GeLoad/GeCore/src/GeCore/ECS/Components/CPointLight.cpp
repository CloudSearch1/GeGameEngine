...
GeCore::ECS::Components::CPointLight::CPointLight(ECS::Actor& p_owner) :
	CLight(p_owner)
{
	m_data.type = static_cast<float>(GeRendering::Entities::Light::Type::POINT);
}

std::string GeCore::ECS::Components::CPointLight::GetName()
{
	return "Point Light";
}

float GeCore::ECS::Components::CPointLight::GetConstant() const
{
	return m_data.constant;
}

float GeCore::ECS::Components::CPointLight::GetLinear() const
{
	return m_data.linear;
}

float GeCore::ECS::Components::CPointLight::GetQuadratic() const
{
	return m_data.quadratic;
}

void GeCore::ECS::Components::CPointLight::SetConstant(float p_constant)
{
	m_data.constant = p_constant;
}

void GeCore::ECS::Components::CPointLight::SetLinear(float p_linear)
{
	m_data.linear = p_linear;
}

void GeCore::ECS::Components::CPointLight::SetQuadratic(float p_quadratic)
{
	m_data.quadratic = p_quadratic;
}

void GeCore::ECS::Components::CPointLight::OnSerialize(tinyxml2::XMLDocument & p_doc, tinyxml2::XMLNode * p_node)
{
...
void GeCore::ECS::Components::CPointLight::OnDeserialize(tinyxml2::XMLDocument & p_doc, tinyxml2::XMLNode * p_node)
{
	using namespace GeCore::Helpers;
...
void GeCore::ECS::Components::CPointLight::OnInspector(GeUI::Internal::WidgetContainer& p_root)
{
	using namespace GeCore::Helpers;
